...
## RGB LED
set_property -dict { PACKAGE_PIN B17   IOSTANDARD LVCMOS33 } [get_ports { o_led[2] }]; #IO_L14N_T2_SRCC_16 Sch=led0_b led bleu
set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS33 } [get_ports { o_led[4] }]; #IO_L13N_T2_MRCC_16 Sch=led0_g led verte
set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { o_led[3] }]; #IO_L14P_T2_SRCC_16 Sch=led0_r led rouge

## Buttons
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { i_btn }]; #IO_L19N_T3_VREF_16 Sch=btn[0]
